...
return [
    'modules' => [
        ...
        'AfterOrder_Mymodule' => 1,
        'Company_Module' => 0,
        'CreateEvent_Mymodule' => 1,
        'Create_Module1' => 1,
        'NewTable_Declarative' => 1,
        'NewTable_Mymodule' => 1,
        'NewTable_Mymodule2' => 1,
        'NewTable_Mymodule3' => 1,
        'NewTable_Mymodule4' => 1,
        'Newcreate_Vendor' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'PlaceOrderAfter_Mymodule1' => 1,
        'Pluginnew_PluginDemo' => 1,
